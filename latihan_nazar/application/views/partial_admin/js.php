<!--   Core JS Files   -->
<script src="<?= base_url('') ?>assets_admin/js/core/jquery.3.2.1.min.js"></script>
	...
	<!-- jQuery UI -->
	<script src="<?= base_url('') ?>assets_admin/js/plugin/jquery-ui-1.12.1.custom/jquery-ui.min.js"></script>
	<script src="<?= base_url('') ?>assets_admin/js/plugin/jquery-ui-touch-punch/jquery.ui.touch-punch.min.js"></script>
	...
	<!-- jQuery Vector Maps -->
	<script src="<?= base_url('') ?>assets_admin/js/plugin/jqvmap/jquery.vmap.min.js"></script>
	<script src="<?= base_url('') ?>assets_admin/js/plugin/jqvmap/maps/jquery.vmap.world.js"></script>

	<!-- Sweet Alert -->
	<script src="/js/plugin/sweetalert/sweetalert.min.js"></script>

	<!-- Atlantis JS -->
	<script src="<?= base_url('') ?>assets_admin/js/atlantis.min.js"></script>
</body>
</html>